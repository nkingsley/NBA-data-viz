    ...
    describe('Team Calcs', function() {
        ...
        describe('ChartController', function() {
            ...
            it('should make a request', function() {
                    ...
                    $httpBackend.expectGET('/init').respond([{
                        Teams[{Team: 'MIA'}]
                    }]);
            ...
            it('$scope.update() should update a valid article', inject(function() {
            ...
            it('$scope.remove() should send a DELETE request with a valid articleId' +
                'and remove the article from the scope', inject(function() {
