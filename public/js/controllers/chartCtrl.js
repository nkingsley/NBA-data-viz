angular.module('mean.chart')
  .controller('chartCtrl', ['$scope', '$http', '$location', 'Global', 'Stats', 'Spearman', 'Teamstar', 'Playerstar', 'Graphrequests', 'Graphcalc',
    'promiseTracker',
    function ($scope, $http, $location, Global, Stats, Spearman, Teamstar, Playerstar, Graphrequests, Graphcalc, promiseTracker) {
    $scope.global = Global;
